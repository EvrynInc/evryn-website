        ...
        <section className="mb-12 md:mb-16 pt-8 border-t border-white/20">
          ...
          <div className="grid md:grid-cols-[1fr_1fr_1.3fr] gap-8 md:gap-10">
            ...
            <div>
              ...
              <p className="text-base text-white/80 leading-relaxed">
                Whoever you need: soulmate, cofounder, crew, someone fun — even that <em>just-right</em> tutor, or just someone to buy an old couch. Not <em>more</em> options. The <em>right</em> ones.
              </p>
            </div>
