        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none text-gray-800">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Our Services may have access to, analyze, and/or ingest, or otherwise allow you to store or transmit content, such as emails and email attachments; files, documents, graphics, images, software, audio and video (collectively, excluding Feedback, &quot;<strong>User Data</strong>&quot;). Evryn does not claim any ownership rights in any User Data and nothing in these Terms will be deemed to restrict any rights that you may have to your User Data.
              </p>
